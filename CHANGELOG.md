...
## [0.12.1](https://github.com/rapm94/feanorfs/compare/v0.12.0...v0.12.1) - 2026-08-25

### Fixed

- *(release)* carry product changes
- *(mesh)* single bounded STUN probe before the punch listener; as_chunks for new clippy
...
## [0.10.1](https://github.com/rapm94/feanorfs/compare/v0.10.0...v0.10.1) - 2026-08-22
...
- *(common)* record the size-checked legacy fallback contract
...
- *(ci)* avoid stale workflow status index
- *(ci)* await Windows runner reconciliation
- *(ci)* make release gates deterministic

## [0.9.1](https://github.com/rapm94/feanorfs/compare/v0.9.0...v0.9.1) - 2026-08-12

### Other

- bound state and tray refreshes ([#60](https://github.com/rapm94/feanorfs/pull/60))
