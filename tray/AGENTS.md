...
- Setup completion copy distinguishes pairing, initial sync, workspace-service installation, and tray registration. Partial failure must describe completed durable work accurately and route retry through `start -- <folder>`; never claim a configured or already-synced folder was not added or unchanged.
